...
async function fetchDataToList() {
    municipalitiesResponse = await fetch('data/municipalities.geojson');
    listOfMunicipalities = await municipalitiesResponse.json();

    postalCodesResponse = await fetch('data/postcode.json');
    listOfPostalCodes = await postalCodesResponse.json();

    observationResponse = await fetch('data/observations.json');
